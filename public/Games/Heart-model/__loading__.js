pc.script.createLoadingScreen(function (app) {
    var showSplash = function () {
        ...
        logo.src = '/Games/3dgame/logoelement.svg';
    ...
    var createCss = function () {
        var css = [
            ...
            '    background: linear-gradient(270deg, #f2e6ff, #d9b3ff);', // Noticeable gradient
            ...
            '    background: linear-gradient(90deg, #8258B1, #381151);', // Gradient for the progress bar',
            '}',
            '',
            ...
            '    width: 5px;',
            '    height: 5px;',
            '    background-color: #381151;', // Dark teal dots',
            '    border-radius: 50%;',
            '    opacity: 0.7;',
