...
const MentorPage = () => {
  return (
    <>
      <div className='bg-transparent w-96 h-96 flex absolute bottom-48 right-9 rounded-lg fade-in'>
        <img src={CloudImage} alt="Cloud" className='transition w-96 h-96 drop-shadow-xl hover:scale-110 animate-floating' />
      </div>

      <div className='bg-transparent w-96 h-96 flex absolute bottom-24 right-40 rounded-lg fade-in'>
        <img src={MentorHero} alt="Cloud" className='transition w-96 h-96 drop-shadow-xl hover:scale-105' />
      </div>

      <div className='bg-transparent w-72 h-72 flex absolute -bottom-4 right-96 rounded-lg fade-in'>
      ...
      <div className='flex flex-col items-center justify-center mt-24 -mb-4 fade-in'>
        <h1 className='text-5xl font-bold drop-shadow-lg transition hover:text-blue-200'>Mentorship</h1>
      ...
      {/* Mentor Cards */}
      <div className='absolute bottom-80 left-60 mb-8 flex items-center justify-start fade-in'>
        <MentorCard image={TeachersImage} title='Connect with Teachers'/>
      </div>

      <div className='absolute bottom-56 left-96 -mb-2 flex items-center justify-start fade-in'>
        <MentorCard image={PerformanceImage} title='Review Your Performance' to='/report'/>
      </div>

      <div className='absolute bottom-20 left-60 flex items-center justify-start fade-in'>
        <MentorCard image={HelpImage} title='Get Some Help & Guidance' to='/students'/>
      </div>
    </>
  );
};
